        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            if (checkpoint == "edit")
            {
                ...
                else
                {
                    ...
                    if (Check_input(c))
                    {
                        strSql = "UPDATE Movies SET Movies.[movieName] = '" + movieTxt.Text + "', Movies.[releaseDate]=#" + releasePick.Value + "#, Movies.[producer]='" +producerTxt.Text + "', Movies.[ageLimit]='" + ageLimitTxt.Text + "', Movies.[genre]='" +genreTxt.Text + "',Movies.[description]='" + descriptionTxt.Text + "' WHERE Movies.[movieCode]='"+movieCode.Text+"'";
